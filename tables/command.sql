...
INSERT INTO `command` VALUES ('account lock ip', '0', 'Syntax: .account lock ip [on|off]\nAllow login from account only from current used IP or remove this requirement.');
...
INSERT INTO `command` VALUES ('character rename', '2', 'Syntax: .character rename [$name] [$newName] \n\nMark selected in game or by $name in command character for rename at next login.\n\nIf $newName then the player will be forced rename.');
...
INSERT INTO `command` VALUES ('lookup spell id', '3', 'Syntax: .lookup spell id #spellid\n\nLooks up a spell by #spellid, and returns the match with its spell name.');
...
INSERT INTO `command` VALUES ('gobject info', '2', 'Syntax: .gobject info [$object_entry]\r \r Query Gameobject information for selected gameobject or given entry.');
...
INSERT INTO `command` VALUES ('reload all eventai', '3', 'Syntax: .reload all eventai\r\n\r\nReload creature_ai_scripts, creature_ai_summons, creature_ai_texts tables.');
...
INSERT INTO `command` VALUES ('lfg player', '2', 'Syntax: .lfg player\n Shows information about player (state, roles, comment, dungeons selected).');
INSERT INTO `command` VALUES ('lfg group', '2', 'Syntax: .lfg group\n Shows information about all players in the group  (state, roles, comment, dungeons selected).');
INSERT INTO `command` VALUES ('lfg queue', '2', 'Syntax: .lfg queue\n Shows info about current lfg queues.');
INSERT INTO `command` VALUES ('lfg clean', '3', 'Syntax: .flg clean\n Cleans current queue, only for debugging purposes.');
INSERT INTO `command` VALUES ('lfg options', '3', 'Syntax: .lfg options [new value]\n Shows current lfg options. New value is set if extra param is present.');
INSERT INTO `command` VALUES ('mmap', '3', 'Syntax: Syntax: .mmaps $subcommand Type .mmaps to see the list of possible subcommands or .help mmaps $subcommand to see info on subcommands');
INSERT INTO `command` VALUES ('mmap path', '3', 'Syntax: .mmap path to calculate and show a path to current select unit');
INSERT INTO `command` VALUES ('mmap loc', '3', 'Syntax: .mmap loc to print on which tile one is');
INSERT INTO `command` VALUES ('mmap loadedtiles', '3', 'Syntax: .mmap loadedtiles to show which tiles are currently loaded');
INSERT INTO `command` VALUES ('mmap stats', '3', 'Syntax: .mmap stats to show information about current state of mmaps');
INSERT INTO `command` VALUES ('mmap testarea', '3', 'Syntax: .mmap testarea to calculate paths for all nearby npcs to player');
INSERT INTO `command` VALUES ('disable add mmap', '3', 'Syntax: .disable add mmap $entry $flag $comment');
INSERT INTO `command` VALUES ('disable remove mmap', '3', 'Syntax: .disable remove mmap $entry');
INSERT INTO `command` VALUES ('group join', '3', 'Syntax: .group join $AnyCharacterNameFromGroup [$CharacterName] \r\nAdds to group of player $AnyCharacterNameFromGroup player $CharacterName (or selected).');
INSERT INTO `command` VALUES ('group list', '3', 'Syntax: .group list [$CharacterName] \r\nLists all the members of the group/party the player is in.');
INSERT INTO `command` VALUES ('rbac account', '3', 'Syntax: .rbac account [$account]\n\nView permissions of selected player or given account\nNote: Only those that affect current realm\n\nNote: Shows real permissions after checking group and roles');
INSERT INTO `command` VALUES ('rbac account group', '3', 'Syntax: .rbac account group [$account]\n\nView groups of selected player or given account\nNote: Only those that affect current realm');
INSERT INTO `command` VALUES ('rbac account group add', '3', 'Syntax: .rbac account group add [$account] #id [#realmId]\n\nAdd a group to selected player or given account.\n\n#reamID may be -1 for all realms.');
INSERT INTO `command` VALUES ('rbac account group remove', '3', 'Syntax: .rbac account group remove [$account] #id\n\nRemove a group from selected player or given account.');
INSERT INTO `command` VALUES ('rbac account role', '3', 'Syntax: .rbac account role [$account]\n\nView roles of selected player or given account\nNote: Only those that affect current realm\nNote: Only those directly granted or denied, does not include inherited roles from groups');
INSERT INTO `command` VALUES ('rbac account role grant', '3', 'Syntax: .rbac account role grant [$account] #id [#realmId]\n\nGrant a role to selected player or given account.\n\n#reamID may be -1 for all realms.');
INSERT INTO `command` VALUES ('rbac account role deny', '3', 'Syntax: .rbac account role deny [$account] #id [#realmId]\n\nDeny a role to selected player or given account.\n\n#reamID may be -1 for all realms.');
INSERT INTO `command` VALUES ('rbac account role revoke', '3', 'Syntax: .rbac account role revoke [$account] #id\n\nRemove a role from an account\n\nNote: Removes the role from granted or denied roles');
INSERT INTO `command` VALUES ('rbac account permission', '3', 'Syntax: .rbac account permission [$account]\n\nView permissions of selected player or given account\nNote: Only those that affect current realm\nNote: Only those directly granted or denied, does not include inherited permissions from roles');
INSERT INTO `command` VALUES ('rbac account permission grant', '3', 'Syntax: .rbac account permission grant [$account] #id [#realmId]\n\nGrant a permission to selected player or given account.\n\n#reamID may be -1 for all realms.');
INSERT INTO `command` VALUES ('rbac account permission deny', '3', 'Syntax: .rbac account permission deny [$account] #id [#realmId]\n\nDeny a permission to selected player or given account.\n\n#reamID may be -1 for all realms.');
INSERT INTO `command` VALUES ('rbac account permission revoke', '3', 'Syntax: .rbac account permission revoke [$account] #id\n\nRemove a permission from an account\n\nNote: Removes the permission from granted or denied permissions');
INSERT INTO `command` VALUES ('rbac list groups', '3', 'Syntax: .rbac list groups [$id]\n\nView list of all groups. If $id is given will show group info and his inherited roles.');
INSERT INTO `command` VALUES ('rbac list roles', '3', 'Syntax: .rbac list roles [$id]\n\nView list of all roles. If $id is given will show role info and his inherited permissions.');
INSERT INTO `command` VALUES ('rbac list permissions', '3', 'Syntax: .rbac list permissions [$id]\n\nView list of all permissions. If $id is given will show only info for that permission.');
INSERT INTO `command` VALUES ('reload creature_summon_groups', '3', 'Syntax: .reload creature_summon_groups\nReload creature_summon_groups table.');
INSERT INTO `command` VALUES ('reload rbac', '3', 'Syntax: .reload rbac\nReload rbac system.');
INSERT INTO `command` VALUES ('deserter instance add', '3', 'Syntax: .deserter instance add $time \n\n Adds the instance deserter debuff to your target with $time duration.');
INSERT INTO `command` VALUES ('deserter instance remove', '3', 'Syntax: .deserter instance remove \n\n Removes the instance deserter debuff from your target.');
INSERT INTO `command` VALUES ('deserter bg add', '3', 'Syntax: .deserter bg add $time \n\n Adds the bg deserter debuff to your target with $time duration.');
INSERT INTO `command` VALUES ('deserter bg remove', '3', 'Syntax: .deserter bg remove \n\n Removes the bg deserter debuff from your target.');
INSERT INTO `command` VALUES ('list mail', '3', 'Syntax: .list mail $character\nList of mails the character received.');
INSERT INTO `command` VALUES ('account lock country', '0', 'Syntax: .account lock country [on|off]\nAllow login from account only from current used Country or remove this requirement.');
INSERT INTO `command` VALUES ('guild rename', '3', 'Syntax: .guild rename \"$GuildName\" \"$NewGuildName\" \n\n Rename a guild named $GuildName with $NewGuildName. Guild name and new guild name must in quotes.');
INSERT INTO `command` VALUES ('arena create', '3', 'Syntax: .arena create $name \"arena name\" #type\n\nA command to create a new Arena-team in game. #type  = [2/3/5]');
INSERT INTO `command` VALUES ('arena disband', '3', 'Syntax: .arena disband #TeamID\n\nA command to disband Arena-team in game.');
INSERT INTO `command` VALUES ('arena rename', '3', 'Syntax: .arena rename \"oldname\" \"newname\"\n\nA command to rename Arena-team name.');
INSERT INTO `command` VALUES ('arena captain', '3', 'Syntax: .arena captain #TeamID $name\n\nA command to set new captain to the team $name must be in the team');
INSERT INTO `command` VALUES ('arena info', '2', 'Syntax: .arena info #TeamID\n\nA command that show info about arena team');
INSERT INTO `command` VALUES ('arena lookup', '2', 'Syntax: .arena lookup $name\n\nA command that give a list of arenateam with the given $name');
